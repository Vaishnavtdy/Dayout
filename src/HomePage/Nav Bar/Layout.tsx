                            ...
                            <div className="headSec">
                                <div className="topMenu">
                                    <ul className="soacialMda">
                                        <li>
                                            <a  href="https://wa.me/+918848965352" target="_blank" className="icon">
                                        ...
                                        <li>
                                            <a href="https://www.facebook.com/p/Dayout-Holidays-100087241266220/" target="_blank" className="icon fb">
                                                <svg width="11" height="21" viewBox="0 0 11 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M7.16235 21V11.55H10.0314L10.5 7.35H7.16235V5.30435C7.16235 4.22285 7.18998 3.15 8.70124 3.15H10.2319V0.147144C10.2319 0.101994 8.91711 0 7.58696 0C4.80899 0 3.06957 1.74006 3.06957 4.9352V7.35H0V11.55H3.06957V21H7.16235Z" fill="white" />
                                                </svg>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="https://www.instagram.com/dayout_holidays/" className="icon" target="_blank">
                                                <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M15.2083 4.14289C15.2083 3.78235 15.5006 3.49009 15.8611 3.49009C16.2216 3.49009 16.5139 3.78235 16.5139 4.14289C16.5139 4.50342 16.2216 4.79569 15.8611 4.79569C15.5006 4.79569 15.2083 4.50342 15.2083 4.14289Z" fill="black" stroke="white" stroke-width="1.3056" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M14.556 1H6.7224C3.83815 1 1.5 3.23898 1.5 6.00091V13.5023C1.5 16.2642 3.83815 18.5032 6.7224 18.5032H14.556C17.4402 18.5032 19.7784 16.2642 19.7784 13.5023V6.00091C19.7784 3.23898 17.4402 1 14.556 1Z" stroke="white" stroke-width="1.9584" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10.6414 13.2818C8.47816 13.2818 6.72461 11.5283 6.72461 9.36504C6.72461 7.20179 8.47816 5.44824 10.6414 5.44824C12.8047 5.44824 14.5582 7.20179 14.5582 9.36504C14.5582 10.4038 14.1455 11.4001 13.411 12.1346C12.6764 12.8691 11.6801 13.2818 10.6414 13.2818Z" stroke="white" stroke-width="1.9584" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M15.8666 3.48957C15.5061 3.48957 15.2138 3.78183 15.2138 4.14237C15.2138 4.5029 15.5061 4.79517 15.8666 4.79517C16.2271 4.79517 16.5194 4.5029 16.5194 4.14237C16.5194 3.78183 16.2271 3.48957 15.8666 3.48957Z" stroke="white" stroke-width="1.3056" stroke-linecap="round" />
                                                </svg>
                                    ...
                                    {/* <div className="logWrap">
                                        <div className="item">
                                            <div className="logBx">
                                                ...
                                                <a href="#!" className="logLnk">Log in</a>
                                            </div>
                                        </div>
                                        <div className="item">
                                            <div className="logBx">
                                ...
                                <div className="NavMenu">
                                    <div className="MenuIcon">
                                        <button type="button" className="btn MenuBtn" id="menuOpen" onClick={handleShow}>
                                            <span></span>
                                            <span></span>
                                            <span></span>
                                        </button>
                                    ...
                                    <Modal show={show} onHide={handleClose}>
                                        ...
                                        <Modal.Body>
                                            <div className="respHead">
                                                <ul>
                                                    <li>
                                                        <a href="" className="menuLink">Home
                                                        </a>
                                                    </li>
                                                    <li>
                                                        ...
                                                        {/* <span className="open">
                                                            <svg width="11" height="6" viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M1 1L5.5 5L10 1" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                            </svg>
                                                        </span> */}
                                                        <span className="close">
                                                            <svg width="11" height="6" viewBox="0 0 11 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M10 5L5.5 1L1 5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                            </svg>
                                                        </span>

                                                    </li>
                                                    <li>
                                                        <a href="" className="menuLink">Gallery

                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="" className="menuLink">Destinations</a>
                                                    </li>
                                                    <li>
                                                        <a href="" className="menuLink">Services

                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="" className="menuLink">Blogs

                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="" className="menuLink">Contact
                                                    ...
                                                    <li>
                                                        ...
                                                        <div className="item">
                                                            <div className="logBx">
                                                                <div className="icon">
                                                                    <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M9 12.5V14.5M4 8.0288C4.47142 8 5.05259 8 5.8 8H12.2C12.9474 8 13.5286 8 14 8.0288M4 8.0288C3.41168 8.0647 2.99429 8.1455 2.63803 8.327C2.07354 8.6146 1.6146 9.0735 1.32698 9.638C1 10.2798 1 11.1198 1 12.8V14.2C1 15.8802 1 16.7202 1.32698 17.362C1.6146 17.9265 2.07354 18.3854 2.63803 18.673C3.27976 19 4.11984 19 5.8 19H12.2C13.8802 19 14.7202 19 15.362 18.673C15.9265 18.3854 16.3854 17.9265 16.673 17.362C17 16.7202 17 15.8802 17 14.2V12.8C17 11.1198 17 10.2798 16.673 9.638C16.3854 9.0735 15.9265 8.6146 15.362 8.327C15.0057 8.1455 14.5883 8.0647 14 8.0288M4 8.0288V6C4 3.23858 6.23858 1 9 1C11.7614 1 14 3.23858 14 6V8.0288"  stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                                    </svg>
                                                                </div>
                                                                <a href="#!" className="logLnk">Log in</a>
                                                            </div>
